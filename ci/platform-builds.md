...
success. The package script runs the full host CTest suite before invoking
Flatpak packaging; the manifest reruns only package-safe smoke tests inside the
